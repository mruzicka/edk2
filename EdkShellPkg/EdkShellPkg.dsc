...
# Dell firmware compatible options
DEFINE GCC_MACRO                 = -DEFI_SPECIFICATION_VERSION=0x0002000A -DPI_SPECIFICATION_VERSION=0x00010000 -DTIANO_RELEASE_VERSION=0x00080006 -DEFI_DEBUG -DSTRING_ARRAY_NAME=$(BASE_NAME)Strings -DSTRING_DEFINES_FILE=\"$(BASE_NAME)StrDefs.h\" -UNO_BUILTIN_VA_FUNCS
...
[BuildOptions.Common.EDK]
  ...
  GCC:NOOPT_*_X64_CC_FLAGS      = -DEFIX64 $(GCC_MACRO) -UEFI_DEBUG
  GCC:DEBUG_*_X64_CC_FLAGS      = -DEFIX64 $(GCC_MACRO)
  GCC:RELEASE_*_X64_CC_FLAGS    = -DEFIX64 $(GCC_MACRO) -UEFI_DEBUG -O3
  GCC:*_*_X64_VFRPP_FLAGS       = -DEFIX64 $(GCC_MACRO)
  GCC:*_*_X64_APP_FLAGS         = -DEFIX64 $(GCC_MACRO)
  GCC:*_*_X64_PP_FLAGS          = -DEFIX64 $(GCC_MACRO)
  GCC:RELEASE_*_X64_DLINK_FLAGS = --defsym=memmove=CopyMem
